...
from src.tasks import generate_and_add_post
...
async def create_post(
    ...
    # data = {**post.dict(), "user_id": current_user.id} # .dict() is deprecated
...
# the get_all_posts function query is like http://localhost:8000/post?sorting=most_likes

...
import pytest
from fastapi.testclient import TestClient  # to test the API without running the server
...
# clear database
# - autouse: make sure every fixture runs before every test
...
def mock_httpx_client(mocker):
    """
    Fixture to mock the HTTPX client so that real HTTP requests are never made (especially important when registering users).
    """
